...
if __name__ == "__main__":
    ...
    # build model
    start_epoch = 0
    global_model = get_global_model_sc_depth(hparams).to(device)
    ...
    for epoch in tqdm(range(start_epoch, total_epochs)):
        ...
        for idx in idxs_users:
            print(f"Computing Local Update of User {idx} ...") 
        ...
        print(f"Global Weights Averaged!")
