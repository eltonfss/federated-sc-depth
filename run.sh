...
RESTORE_DIR="$OUTPUT_DIR/20_08_2023_11:51:12" # BY DRIVE
...
#FED_TRAIN_AVG_SEARCH_RANGE=12
#FED_TRAIN_AVG_SEARCH_RANGE=24
#FED_TRAIN_AVG_SEARCH_RANGE=10000

#FED_TRAIN_AVG_SEARCH_STRATEGY="" # StandardFedAvg
#FED_TRAIN_AVG_SEARCH_STRATEGY="BayesianRegressionGrid"
#FED_TRAIN_AVG_SEARCH_STRATEGY="ConstrainedBayesianRegressionGrid"
