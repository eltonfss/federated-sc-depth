...
#RESTORE_DIR="$OUTPUT_DIR/14_06_2023_23:04:06" # IID
RESTORE_DIR="$OUTPUT_DIR/20_06_2023_21:31:43" # BY DRIVE
MAX_LOCAL_TRAIN_BATCHES=25
...
FRAC_PARTICIPANTS_PER_ROUND=0.066666
