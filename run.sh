...
RESTORE_DIR="$OUTPUT_DIR/11_11_2024_17:54:25"
...
--fed_train_average_search_acquisition_function=$FED_TRAIN_AVG_SEARCH_ACQUISITION_FUNCTION \
--fed_train_average_search_acquisition_optimizer=$FED_TRAIN_AVG_SEARCH_ACQUISITION_OPTIMIZER
