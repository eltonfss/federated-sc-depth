...
RESTORE_DIR="$OUTPUT_DIR/01_08_2023_00:05:11" # BY DRIVE
...
#FED_TRAIN_AVG_SEARCH_RANGE=18
#FED_TRAIN_AVG_SEARCH_RANGE=36

#FED_TRAIN_AVG_SEARCH_STRATEGY="" # StandardFedAvg
FED_TRAIN_AVG_SEARCH_STRATEGY="BayesianLinearGrid"
#FED_TRAIN_AVG_SEARCH_STRATEGY="ConstrainedBayesianLinearGrid"
