...
def get_configargs():
    ...
    parser.add_argument("--fed_train_average_search_strategy", type=str, default="", help="GridSearch,RandomSearch,BayesianOptimization,ConstrainedRandomSearch,ConstrainedBayesianOptimization,ReinforcementLearning")
