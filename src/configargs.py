...
def get_configargs():
    ...
    parser.add_argument("--fed_train_num_local_epochs", type=int, default=100, help="the number of local epochs executed by each participant per round: E")
    parser.add_argument("--fed_train_num_local_train_batches", type=int, default=1000, help="the number of batches used for training each local model per round: E")
    parser.add_argument("--fed_train_num_local_val_batches", type=int, default=1000, help="the number of batches used for validating each local model per round: E")
