...
def get_configargs():
    ...
    parser.add_argument("--fed_train_average_search_strategy", type=str, default="", help="GridSearch,RandomSearch,BayesianOptimization,ReinforcementLearning,ConstrainedRandomSearch,ConstrainedBayesianOptimization,ConstrainedReinforcementLearning,BayesianRegressionGrid,ConstrainedBayesianRegressionGrid")
    parser.add_argument("--fed_train_average_search_acquisition_function", type=str, default="gp_hedge", help="gp_hedge, EI, LCB, PI")
    parser.add_argument("--fed_train_average_search_acquisition_optimizer", type=str, default="auto", help="sampling, lbfgs, auto")
