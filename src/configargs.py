...
def get_configargs():
    ...
    parser.add_argument("--fed_train_average_grid_optimization_range", type=int, default=-1, help="Range of denominators evaluated in a grid to optimize weighted averaging based on the loss of the global model. If equals -1, no optimization is performed")
