...
def initialize_er_buffer(
    ...
    for dataset_name, dataset_dir in datasets:
        ...
        if global_er_buffer.is_empty():
            ...
            er_initializer = ExperienceReplayBufferInitializer(dataset_name, global_er_buffer)
        else:
...
class ExperienceReplayBufferInitializer(LightningModule):
    ...
    def __init__(self, dataset_name, global_er_buffer: ExperienceReplayBuffer, *args: Any, **kwargs: Any):
        super().__init__(*args, **kwargs)
        self._dataset_name = dataset_name
        self._er_buffer = global_er_buffer
