...
# (FEDSCDEPTH-KITTI) DISTRIBUTION = IID; TOTAL PARTICIPANTS = 4 ; PARTICIPANTS PER ROUND = 12 ; LOCAL EPOCHS = 3; SEARCH RANGE = -1; MAX LOCAL BATCHES TRAIN = 1000; MAX LOCAL BATCHES VAL = -1; MAX_ROUNDS = 36 ;
#FEDERATED_MODEL_TIMESTAMP='15_11_2023_02:38:56'
#FEDERATION_ROUND=3

# (BOFEDSCDEPTH-KITTI) DISTRIBUTION = IID; TOTAL PARTICIPANTS = 4 ; PARTICIPANTS PER ROUND = 12 ; LOCAL EPOCHS = 3; SEARCH RANGE = 6; MAX LOCAL BATCHES TRAIN = 1000; MAX LOCAL BATCHES VAL = -1; MAX_ROUNDS = 36 ;
